 ...
 * REVISED for COMP 445:  Libby Shoop   3/19/19
 ****************************************************************************/
#include <mpi.h>
#include <stdio.h>
#include <stdlib.h>
...
#define MAXWORKER   19                  /* maximum number of worker tasks */
...
/* First, find out my taskid and how many tasks are running */
   ...
   if (taskid == MASTER) {
      ...
      // LS master starts timing after initialization of grid
   ...
   if (taskid != MASTER)
   {
      ...
      MPI_Barrier(MPI_COMM_WORLD);   // LS workers each wait until master done intializing
